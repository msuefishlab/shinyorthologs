...
CREATE TABLE genes (GENE_ID varchar(255) PRIMARY KEY, SPECIES_ID varchar(255), SYMBOL varchar(255));
CREATE TABLE orthodescriptions (ORTHOLOG_ID varchar(255) PRIMARY KEY, DESCRIPTION varchar(2024));
CREATE TABLE orthologs (ORTHOLOG_ID varchar(255) REFERENCES orthodescriptions, SPECIES_ID varchar(255), GENE_ID varchar(255));
