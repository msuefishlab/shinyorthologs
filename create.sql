...
CREATE TABLE genes (GENE_ID varchar(255), SPECIES_ID varchar(255), SYMBOL varchar(255));
CREATE TABLE orthologs (ORTHOLOG_ID varchar(255), SPECIES_ID varchar(255), GENE_ID varchar(255));
CREATE TABLE orthodescriptions (ORTHOLOG_ID varchar(255), DESCRIPTION varchar(2024));
